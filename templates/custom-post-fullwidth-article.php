    ...
    <div class="single-news-intro">
        ...
        <div class="date-share-wrapper">
            <div class="single-news-date">
                ...
                if ($hide_author !== "1") {
                  ?> / <?php echo esc_html($authorFirstName); ?> <?php echo esc_html($authorLastName);
                }
                ?>
            </div>
                ...
                if ($hide_socials !== "1" && $show_any_social) {
                    ...
                    <div class="col-12 social-column social-column-grey">
                        ...
                        <a class="bluesky-share-btn"
                           ...
                           <svg width="24" height="24" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 21.2" aria-hidden="true" focusable="false"><path d="M5.429 1.761C8.089 3.758 10.95 7.807 12 9.98c1.05 -2.173 3.911 -6.222 6.571 -8.218C20.49 0.32 23.6 -0.794 23.6 2.753c0 0.708 -0.406 5.952 -0.644 6.803 -0.828 2.959 -3.846 3.714 -6.53 3.257 4.692 0.799 5.886 3.444 3.308 6.089 -4.896 5.024 -7.036 -1.26 -7.585 -2.871 -0.101 -0.295 -0.148 -0.433 -0.148 -0.316 -0.001 -0.117 -0.048 0.021 -0.148 0.316 -0.549 1.61 -2.689 7.894 -7.585 2.871 -2.578 -2.645 -1.384 -5.29 3.308 -6.089 -2.684 0.457 -5.702 -0.298 -6.53 -3.257C0.806 8.705 0.4 3.461 0.4 2.753c0 -3.547 3.11 -2.433 5.029 -0.992z" fill="#0021A5"/></svg>
                        </a>
                        <?php endif; ?>
